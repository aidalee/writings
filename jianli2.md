 ...
 * @LastEditors: please
 * @LastEditTime: 2023-11-27 13:06:41
 * @Description: 请填写简介
-->
- 基本信息：
1. 姓名
...
- 技能概述
1. 熟练掌握html、css、javascript，能够精确还原设计稿并实现各种动画特效交互效果
2. 熟练掌握vue、react、typescript技术栈，具备熟练开发移动端H5、pc端管理系统与官网等各类系统的能力
3. 熟悉微信小程序开发、抖音小程序开发、支付宝生活号开发，并具备多个项目经验
4. 熟悉数据可视化开发，并具有大规模数据的可视化渲染经验，熟悉Echarts、antv定制化开发各类图表、地图轨迹渲染等
...
2. 所托-小安象小程序平台
  ...
  - 数据中心各类统计数据图表展示
  - 使用原生微信小程序技术，微信SDK与API，综合使用weVantUI，持续跟进迭代研发
  - 独立负责严选商城各类型商品分页渲染、商品详情展示与下单支付流程，行驶证驾驶证OCR识别、小程序跳转小程序、小程序跳转第三方H5，所托无忧包各类型产品询价与购买流程，在途互动模块语音发送与接收、视频观看功能
  ...
  - 封装上拉加载更多分页数据列表的业务逻辑为一个通用的behaviors，方便多场景列表加载使用
...
- 封装系统面包屑导航组件、菜单栏组件、表单弹框组件、Echarts图表组件等，mixins提取通用
